...
for filename in *.{png,jpg,JPG,jpeg,JPEG,webp,png.br,css.br,html.br,svg.br,css.gz,html.gz,svg.gz}
do
    echo                                                                    >> resources.toit
...
for filename in *.{png,jpg,JPG,jpeg,JPEG,webp,css,html,svg,png.br,css.br,html.br,svg.br,css.gz,html.gz,svg.gz}
do
